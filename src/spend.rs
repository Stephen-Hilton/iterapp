...
pub fn is_usage_limit_error(error: &str) -> bool {
    ...
    let e = stripped.split_whitespace().collect::<Vec<_>>().join(" ");
    const NEEDLES: &[&str] = &[
        // Subscription usage limits — claude CLI phrasings, old and new.
        ...
        // Terminal account states — equally fatal for every turn that would follow.
