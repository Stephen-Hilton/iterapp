...
6. **Later**: MCP layer on iter_data; cargo-lambda + API Gateway deploy; webui feature parity with V2 webapp; structure-snapshot push and the coordinated pdy-dev migration (NOT before coordination); V2→V3 data migration (manual, on request).
